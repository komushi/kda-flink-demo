...
public class StreamJobTumbling {

    private static final Logger log = LoggerFactory.getLogger(StreamJobTumbling.class);
    ...
    public static void main(String[] args) throws Exception {
        try {
            log.warn("StreamJobTumbling main");
            ...
            String intervalExpression = processorConfigProperties.getProperty("INTERVAL_EXPRESSION");
...
//                        log.warn(object.toString());
            ...
            String interval = processorConfigProperties.getProperty("INTERVAL");
            String uom = processorConfigProperties.getProperty("UOM");

            Table resultTable = inputTable
                .window(Tumble.over(intervalExpression).on("rowtime").as("w"))
                .groupBy("w, N02_001")
                .select("N02_001 as RAILWAY_CLASS, N02_001.count as RAILWAY_CLASS_COUNT, w.start as WINDOW_START, w.end as WINDOW_END");
